...
**R3:** Genereate a puck that collides with bars and arena wall.
Upon collision with either a bar or a wall, alter the pucks direction and angle (remember vectors from math? May wanna look into that...)
